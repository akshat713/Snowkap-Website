...
# The prompt lives in shared/chat-system-prompt.md so that this backend and the
# edge worker in edge/ cannot drift apart. Two copies of a 9KB system prompt is
# two copies to forget to update.
CHAT_SYSTEM_FULL = (ROOT_DIR.parent / "shared" / "chat-system-prompt.md").read_text(encoding="utf-8")
