...
export default function TestimonialsSection() {
  return (
    <section className="py-24 md:py-36 bg-surface border-y border-white/10" data-testid="testimonials-section">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {TESTIMONIALS.map((t, i) => (
            <Reveal key={t.name} i={i} className="h-full">
              <figure className="bg-bg border border-white/10 p-8 md:p-9 h-full flex flex-col hover:border-white/25 transition-colors" data-testid={`testimonial-${i}`}>
